...
def PointPointProb(d,e,cov):
    ...
    corr_coeff = varxy / (varx * vary) # definition of the correlation coefficient
    
    # see definition of z^2 in the bivariate gaussian distribution in 
    # Ivezic Textbook, 2014
